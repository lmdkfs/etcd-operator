...
func NewStatefuleSet(etcd *v1alpha1.Etcd) *appsv1.StatefulSet {
	return &appsv1.StatefulSet{
		...
		ObjectMeta: metav1.ObjectMeta{
			...
			Labels:    map[string]string{"etcd.zrq.org.cn/v1alpha1": etcd.Name},
		...
		Spec: appsv1.StatefulSetSpec{
			...
			Selector: &metav1.LabelSelector{
				MatchLabels: map[string]string{"etcd.zrq.org.cn/v1alpha1": etcd.Name},
			},
					...
					Containers: []corev1.Container{
						corev1.Container{
							...
							Env: []corev1.EnvVar{
								...
								corev1.EnvVar{Name: "NAMESPACE", ValueFrom: &corev1.EnvVarSource{FieldRef: &corev1.ObjectFieldSelector{FieldPath: "metadata.namespace"}}},
							},
					...
					Spec: corev1.PersistentVolumeClaimSpec{
						...
						Resources: corev1.ResourceRequirements{
							Requests: corev1.ResourceList{
								corev1.ResourceStorage: resource.MustParse(fmt.Sprintf("%vGi", etcd.Spec.Storage)),
							},
						},
					},
				},
